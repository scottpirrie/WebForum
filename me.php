                            ...
                            <form method="POST" action="me.php" class="form" name="register"
                                ...
                                <div class="container col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <input class="form-control" id="curPassword" type=password name="curPassword"
                                               minlength="4"
                                               maxlength="15"
                                               required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="form-control" id="passToBe" type=password name="newPassword"
                                               minlength="4"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-form-label" for="passToBeRepeat">Repeat New
                                            Password:</label>
                                        <input class="form-control" id="passToBeRepeat" type=password
