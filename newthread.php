            ...
            <div class="panel-body">
                <form id = "create-thread" class="form" method="post" action="home.php">
                    ...
                    <div class="form-group  col-md-4 ">
                        ...
                        <input  class="form-control" type="text" id="threadName" name="threadName" required minlength="2" maxlength="30">
                    </div>

                    <div class="form-group  col-md-12 ">
                        <label class="col-form-label" for="post">Post:</label>
                        <textarea class="form-control" rows="20" name="post" form="create-thread"></textarea><br>
                    </div>
